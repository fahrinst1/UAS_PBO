...
public class DtMahaiswa extends javax.swing.JFrame {
    ...
    Connection fahri = koneksii.BukaKoneksi();
    ...
    private void btnsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsimpanActionPerformed
        ...
        try {
            ...
            if (btnsimpan.getText()=="Simpan") {
                ...
                String cek ="SELECT * FROM data_mahasiswa WHERE kode = '" + txtkodeMahasiswa.getText()+"'";
                rs = st.executeQuery(cek);
                if (rs.next()) {
                    JOptionPane.showMessageDialog(null,"Kode Barang Sudah dipakai");
                }else{
                   
                    String sql = "INSERT INTO data_mahasiswa VALUES('" + txtkodeMahasiswa.getText()+
        ...
        if (txtkodeMahasiswa.getText().equals("")) {
            JOptionPane.showMessageDialog(this,"Pilih data yang ingin dihapus");
             ...
             if (jawab ==0) {
                 try {
                     st = fahri.createStatement();
                     String sql = "DELETE FROM data_mahasiswa WHERE kode = '"+ txtkodeMahasiswa.getText()+"'";
                     st.executeUpdate(sql);
